...
export async function SearchMovie(query) {
    const search = await axios.get(`https://api.themoviedb.org/3/search/movie?query=${query}&api_key=9cd0dda93c2009fed108da3042f91609&language=en-US&page=1`);
    return search.data;
};
...
export async function MovieCredits(id) {
    const credits = await axios.get(`https://api.themoviedb.org/3/movie/${id}/credits?api_key=9cd0dda93c2009fed108da3042f91609&language=en-US`);

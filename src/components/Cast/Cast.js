            ...
            {actors !== [] && 
                <ActorContainer>
                    {actors.map(({id, profile_path, original_name, character}) => (
                        <li key={id}>
                            {profile_path ?
                                (<ActorImg src={`https://image.tmdb.org/t/p/w500${profile_path}`} alt="No image" />) 
                                :
                                // eslint-disable-next-line jsx-a11y/img-redundant-alt
                                (<img src="http://artismedia.by/blog/wp-content/uploads/2018/05/in-blog2-1.png" alt="No image" height={300} width={200}/>)
                           }
                <div>
